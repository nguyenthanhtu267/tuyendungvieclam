...
import { companiesApi, ApiError, type CompanyProfileResponse } from '@/lib/api';
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-6">
        ...
        <div className="rounded-2xl bg-primary p-6 flex items-center gap-4 flex-wrap">
          <div className="w-16 h-16 rounded-xl bg-white/15 text-white flex items-center justify-center font-extrabold text-lg shrink-0">
